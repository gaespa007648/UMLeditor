...
import CanvasObj.CompositionLineObj;
...
public class CompositionMode extends mode{
	...
	public void mouseClicked(MouseEvent e){
		System.out.println("CompositionMode click");
	}
	public void mousePressed(MouseEvent e){
		System.out.println("CompositionMode pressed");
		...
		if(index!=-1){
			...
			if(p1!=null){
				CanvasObj line = new CompositionLineObj(p1,null);
	...
	public void mouseReleased(MouseEvent e){
		System.out.println("CompositionMode release");
		Canvas instance = Canvas.getInstance();
		int index = instance.checkInside(e.getX(), e.getY());
